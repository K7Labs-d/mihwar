...
const sections = {
  ...
  'broker-opportunities': { icon: Handshake, heading: 'فرص التعاون', empty: 'لا توجد فرص مشتركة للعرض بعد', description: 'إتاحة فرص التعاون وربطها بالوسطاء قيد الإكمال. تسجيل وسيط لا ينشئ فرصة تعاون تلقائيًا.', columns: ['الفرصة', 'الوسيط', 'الحالة'], related: ['broker-management', 'broker-registration'] },
  'broker-reports': { icon: ChartNoAxesColumn, heading: 'تقارير أداء الوسطاء', empty: 'لا توجد تقارير أداء متاحة بعد', description: 'حساب مؤشرات الأداء وإعداد التقارير قيد الإكمال. يمكنك الآن متابعة حالة طلبات الوسطاء من إدارة الوسطاء.', columns: ['التقرير', 'الفترة', 'الحالة'], related: ['broker-management', 'broker-opportunities'] },
  'broker-settings': { icon: Settings, heading: 'إعدادات فرع الوسيط', empty: 'لا توجد إعدادات متاحة للتعديل بعد', description: 'إعدادات فرع الوسيط قيد الإكمال. بيانات حسابك متاحة في حساب العميل، وحالة طلبك في إدارة الوسطاء.', columns: [], related: ['client', 'broker-management'] },
